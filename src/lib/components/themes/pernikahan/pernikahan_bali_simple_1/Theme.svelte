<script lang="ts">
	...
	import { createTextHelper } from '$lib/utils/theme-text.js';
	import { createStyleHelper } from '$lib/utils/theme-style.js';
	...
	import SectionEditButton from '$lib/components/invitation/section-edit-button.svelte';
	...
	const groomPhoto = media.getFirstUrl('groom_photo');
	const bridePhoto = media.getFirstUrl('bride_photo');
	const galleryImages = media.getAll('gallery_grid');
	const promoVideo = media.getFirstUrl('promo_video');
...
>
	...
	{#if heroPhoto}
		...
		>
			<SectionEditButton slotKey="hero_overlay" tab="style" label="Edit Tampilan Hero" />
			<img
				src={getMediaUrl(heroPhoto)}
				alt="Hero"
				class="absolute inset-0 w-full h-full object-cover opacity-80"
			/>
			<div class="absolute inset-0" style={style.css('hero_overlay')}></div>
	...
	<!-- INTRO SECTION -->
	<section class="relative py-20 px-6 text-center" style={style.css('intro_section')}>
		<SectionEditButton slotKey="intro_section" tab="style" label="Edit Tampilan" />
		<SectionEditButton
			slotKey="greeting_title"
			tab="text"
			label="Edit Teks"
			class="top-14 right-4"
		/>
		<div class="max-w-4xl mx-auto">
			<h2 class="font-script text-4xl md:text-5xl mb-6">{@html text.render('greeting_title')}</h2>
			<p class="leading-relaxed max-w-2xl mx-auto mb-16">
				{@html text.render('greeting_body')}
			</p>
	...
	{#if schedules && schedules.length > 0}
		<section
			...
			style={style.css('schedule_section')}
		>
			<SectionEditButton slotKey="schedule_section" tab="style" label="Edit Tampilan Jadwal" />
			<SectionEditButton
				slotKey="schedule_title"
				tab="text"
				label="Edit Teks Jadwal"
				class="top-14 right-4"
			/>
			<div class="max-w-4xl mx-auto relative z-10">
				<h3 class="font-script text-5xl md:text-6xl mb-12">{text.render('schedule_title')}</h3>
				<div
	...
	<section class="relative py-20 px-6">
		<SectionEditButton slotKey="quote_card" tab="style" label="Edit Kartu Kutipan" />
		<SectionEditButton
			slotKey="quote_text"
			tab="text"
		...
		<div class="max-w-3xl mx-auto text-center">
			...
			>
				...
				<p class="italic text-lg md:text-xl mb-4 font-serif leading-relaxed">
					{@html text.render('quote_text')}
				</p>
				<p class="font-bold tracking-widest uppercase text-sm">
					{@html text.render('quote_source')}
				</p>
			</div>
		</div>
	</section>
						...
						{#if gift.type !== 'physical'}
							...
							>
								...
								<div class="grow flex flex-col justify-center my-4">
									<p class="text-3xl font-mono text-stone-900 tracking-widest mb-2">
										{gift.account_number}
									</p>
									<p class="text-stone-500 uppercase tracking-wider text-sm">
