<script lang="ts">
	import { getSeminarContext } from '$lib/contexts/invitation-context.js';
	...
	const bannerImage = media.getFirstUrl('hero_banner');
	const speakerPhotos = media.getAll('speaker_photos');
