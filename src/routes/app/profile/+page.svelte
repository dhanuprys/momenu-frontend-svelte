...
<div class="container mx-auto max-w-7xl px-4 py-12 md:px-8 relative">
	...
	{#if user}
		<div class="grid gap-8 lg:grid-cols-3 items-start">
			...
			<div class="lg:col-span-1">
				<Card.Root
					class="overflow-hidden border-0 shadow-xl bg-white/60 dark:bg-stone-900/60 backdrop-blur-xl relative group transition-all duration-500 hover:shadow-2xl"
				>
					<Card.Content class="pt-8 pb-8 flex flex-col items-center text-center relative z-10">
						<div class="relative mb-6 group cursor-pointer">
							<Avatar.Root
								class="h-32 w-32 relative border-4 border-background shadow-lg transition-transform duration-500 group-hover:scale-105"
							>
						...
						<h3
							class="text-2xl font-bold mb-1 truncate w-full px-4 text-stone-900 dark:text-stone-100"
						...
						<div class="flex gap-2 justify-center flex-wrap">
							{#if user.is_admin}
								<Badge
									class="bg-primary/10 text-primary hover:bg-primary/20 border-0 font-semibold px-3 py-1"
									>Admin</Badge
								>
							{:else}
								<Badge
									variant="secondary"
									class="bg-stone-100 dark:bg-stone-800 text-stone-600 dark:text-stone-300 border-0 font-semibold px-3 py-1 hover:bg-stone-200 dark:hover:bg-stone-700"
									>Pengguna</Badge
								>
							{/if}
							...
							{#if user.google_id}
								<Badge
									variant="outline"
									class="border-blue-200/50 text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 font-semibold px-3 py-1"
								>
									<svg
										class="w-3.5 h-3.5 mr-1.5 inline"
										viewBox="0 0 24 24"
				...
				<Card.Root class="border-0 shadow-lg bg-white/80 dark:bg-stone-900/80 backdrop-blur-md">
					<Card.Header class="pb-8 border-b border-stone-100 dark:border-stone-800">
						...
						<Card.Description class="text-base mt-1"
							>Detail informasi mengenai akun Momenu Anda.</Card.Description
						>
					</Card.Header>
					<Card.Content class="space-y-2 pt-6">
						<!-- Info Row 1 -->
						<div
							class="group flex items-start sm:items-center gap-4 p-4 md:p-5 rounded-2xl hover:bg-stone-50 dark:hover:bg-stone-800/50 transition-colors duration-300"
						>
							<div
								class="p-3 bg-stone-100 dark:bg-stone-800 rounded-xl shrink-0 group-hover:scale-110 group-hover:bg-blue-500/10 group-hover:text-blue-500 transition-all duration-300"
							>
							...
							<div class="space-y-1 w-full flex-1">
								...
								>
									<div class="flex-1 mr-4">
										...
										{:else}
											<p
												class="text-base font-medium text-stone-900 dark:text-stone-100 mt-0.5 truncate"
											>
												{user.name || '-'}
											</p>
										{/if}
						...
						>
							<div
								class="p-3 bg-stone-100 dark:bg-stone-800 rounded-xl shrink-0 group-hover:scale-110 group-hover:bg-primary/10 group-hover:text-primary transition-all duration-300"
							>
							...
							<div class="space-y-1 overflow-hidden flex-1">
								...
								<p class="text-base font-medium text-stone-900 dark:text-stone-100 truncate">
									{user.email}
								</p>
							</div>
						</div>
						...
						>
							<div
								class="p-3 bg-stone-100 dark:bg-stone-800 rounded-xl shrink-0 group-hover:scale-110 group-hover:bg-emerald-500/10 group-hover:text-emerald-500 transition-all duration-300"
							>
								<Calendar
									class="h-6 w-6 text-stone-500 group-hover:text-emerald-500 transition-colors"
								/>
							</div>
							<div class="space-y-1 flex-1">
								...
								<p class="text-base font-medium text-stone-900 dark:text-stone-100">
						...
						>
							<div
								class="p-3 bg-stone-100 dark:bg-stone-800 rounded-xl shrink-0 group-hover:scale-110 group-hover:bg-purple-500/10 group-hover:text-purple-500 transition-all duration-300"
							>
	...
	{:else}
		<!-- Empty / Loading State -->
		<div
			class="flex flex-col items-center justify-center py-20 px-4 text-center relative overflow-hidden rounded-3xl border border-stone-200 dark:border-stone-800 bg-white/50 dark:bg-stone-900/50 backdrop-blur-sm"
		>
			<div class="relative z-10 flex flex-col items-center">
				...
				<p class="text-muted-foreground max-w-sm">
					Sedang mengambil informasi pengguna yang aman...
				</p>
			</div>
		</div>
	{/if}
